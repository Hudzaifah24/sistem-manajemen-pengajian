<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="flex flex-row col-span-6 gap-3 sm:col-span-4">
            <!-- Phone Number -->
            <div class="w-full">
            ...
            <div class="w-full">
                ...
                <x-select id="gender" class="block w-full mt-1" wire:model="state.gender" required>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-textarea id="address" type="text" class="block w-full mt-1" wire:model="state.address" required />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="city" type="text" class="block w-full mt-1" wire:model="state.city" required />
        ...
        <div class="flex flex-row col-span-6 gap-3 sm:col-span-4">
            ...
            <div class="w-full">
                ...
                <x-input id="birth_date" type="date" class="block w-full mt-1"
            ...
            <div class="w-full">
                ...
                <x-input id="birth_place" type="text" class="block w-full mt-1" wire:model="state.birth_place" />
        ...
        <!-- Kelompok -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="division" value="{{ __('Kelompok') }}" />
            <x-select id="division" class="block w-full mt-1" wire:model="state.division_id">
