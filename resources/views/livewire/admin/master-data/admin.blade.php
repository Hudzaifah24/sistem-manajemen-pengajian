  ...
  <div class="flex-col items-center gap-5 mb-4 sm:flex-row md:flex md:justify-between lg:mr-4">
    ...
    @if (Auth::user()->isSuperadmin)
      <x-button wire:click="showCreating">
        <x-heroicon-o-plus class="w-4 h-4 mr-2" /> Tambah Admin
      </x-button>
    @endif
  </div>
  <div class="overflow-x-scroll">
    <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
      <thead class="bg-gray-50 dark:bg-gray-900">
        <tr>
          <th scope="col" class="relative px-2 py-2 text-xs font-medium text-center text-gray-500 dark:text-gray-300">
            No.
          </th>
      ...
      <x-slot name="content">
        ...
        <div class="flex flex-col gap-4 mt-4 sm:flex-row sm:gap-3">
          ...
          <div class="w-full">
            ...
            <x-select id="form.group" class="block w-full mt-1" wire:model="form.group" required>
    ...
    @if ($form->user)
      ...
      <div class="px-6 py-4">
        <div class="flex items-center justify-center my-4">
          <img class="object-cover w-32 h-32 rounded-full" src="{{ $form->user->profile_photo_url }}"
