<div>
    <div class="mb-4 flex-col items-center gap-5 sm:flex-row md:flex md:justify-between lg:mr-4">
        ...
        <x-button wire:click="showCreating">
            <x-heroicon-o-plus class="mr-2 h-4 w-4" /> Tambah Peserta
        </x-button>
    </div>
        ...
        <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-50 dark:bg-gray-900">
                <tr>
                    ...
                    <th scope="col"
                        class="hidden px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 sm:table-cell">
                        Actions
                    </th>
                </tr>
            </thead>
