      ...
      <div>
        ...
        <form wire:submit.prevent="export">
          ...
          <x-select id="division" name="division" class="mb-4" wire:model.live="division">
            <option value="">{{ __('Select Kelompok') }}</option>
          ...
          <div class="flex flex-col items-center gap-4 justify-stretch">
            ...
            <x-button class="justify-center w-full" wire:loading.attr="disabled">
              {{ __('Export') }}
            </x-button>
          </div>
        </form>
        ...
        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-800">
          @foreach ($attendances as $attendance)
            <tr class="{{ $trClass }}">
              ...
              <td class="{{ $tdClass }}">
                <img src="{{ $attendance->attachment }}" class="object-contain max-h-48">
              </td>
            </tr>
          @endforeach
        </tbody>
