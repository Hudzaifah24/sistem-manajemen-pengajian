          ...
          <form action="{{ route('admin.barcodes.update', $barcode->id) }}" method="post">
            ...
            <div class="flex flex-col gap-4 md:flex-row md:items-start md:gap-3">
              <div class="w-full">
                ...
                <x-input name="name" id="name" class="block w-full mt-1" type="text"
            ...
            <div class="flex gap-3 mt-4">
              <div class="w-full">
                ...
                <x-input name="radius" id="radius" class="block w-full mt-1" type="number" :value="old('radius') ?? $barcode->radius"
                ...
                <x-select id="shift_id" name="shift_id" class="block w-full mt-1">
                    ...
                    @foreach (App\Models\Shift::all() as $shift)
                        <option value="{{ $shift->id }}"
                            {{ $shift->id == $barcode->shift_id ? 'selected' : '' }}>
                            {{ $shift->name }}
                        </option>
                    @endforeach
                </x-select>
            ...
            <div class="mt-5">
              ...
              <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                <div class="w-full">
                  ...
                  <x-input name="lat" id="lat" class="block w-full mt-1" type="text" :value="old('lat') ?? $barcode->latLng['lat']"
                ...
                <div class="w-full">
                  ...
                  <x-input name="lng" id="lng" class="block w-full mt-1" type="text" :value="old('lng') ?? $barcode->latLng['lng']"
                    placeholder="cth: 6.12345" />
                  @error('lng')
