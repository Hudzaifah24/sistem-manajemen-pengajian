...
use App\Livewire\Admin\UserQrScanner;
...
Route::middleware([
    ...
    Route::prefix('admin')->middleware('admin')->group(function () {
        ...
        //scan peserta
        // Route::get('/scan-peserta', UserQrScanner::class)->name('admin.scan.peserta');
        ...
        // Master Data
        Route::get('/masterdata/kelompok', [MasterDataController::class, 'division'])
        ...
        Route::get('/masterdata/acara', [MasterDataController::class, 'shift'])
